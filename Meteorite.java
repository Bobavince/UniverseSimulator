...
public class Meteorite extends Particule {
	...
	protected void dessiner(Graphics g, double[] coefficient, int dessinX, int dessinY){
		...
		if(Affichage.debug){System.out.println("DESSIN METEORITE");};
		//DEBUG //
		...
		try {
			sourceImage = ImageIO.read(new File("MeteoriteF.png"));
			if(Affichage.debug){System.out.println("METEORITE : image importée successful ");};
