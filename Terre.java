...
public class Terre extends Particule {
	...
	protected void dessiner(Graphics g, double[] coefficient, int dessinX, int dessinY){
		...
		if(Affichage.debug){System.out.println("DESSIN TERRE");};
		//DEBUG //
		...
		try {
			sourceImage = ImageIO.read(new File("EarthF.png"));
			if(Affichage.debug){System.out.println("TERRE : image importée successful ");};
