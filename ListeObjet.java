...
public class ListeObjet {
	...
	public void dessinerListe(Graphics g, int maxX, int maxY, int minX, int minY, int dessinX, int dessinY){

		for (int i=0; i< this.listeParticule.size(); i++){
			this.listeParticule.get(i).dessiner(g, maxX, maxY, minX, minY, dessinX, dessinY);
		}
	}
